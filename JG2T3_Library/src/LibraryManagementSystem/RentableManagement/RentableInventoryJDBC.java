		...
		try {
			...
			while (resultSet.next()) {
				...
				if (type.toLowerCase().equals("book") || type.toLowerCase().equals("ebook")) {
					result = "SKU: " + resultSet.getString(1) + ", Title: " + resultSet.getString(2)
					...
					result = "SKU: " + resultSet.getString(1) + ", Room Number: " + resultSet.getString(7);
				}
	...
	public String viewRentables() {
		...
		try {
			...
			while (resultSet.next()) {
				...
				if (type.toLowerCase().equals("book") || type.toLowerCase().equals("ebook")) {
					result = "Rentable Id: " + resultSet.getString(1) + "Upc: " + resultSet.getString(2) 
							+ ", Title: " + resultSet.getString(3) + ", ISBN: " + resultSet.getString(4) 
							+ ", Condition: " + resultSet.getString(5) + ", Genre: " + resultSet.getString(6) 
							+ ", Type: " + resultSet.getString(7) + "Availability: " + resultSet.getString(8);
				} else if (type.toLowerCase().equals("dvd")) {
					result = "Rentable Id: " + resultSet.getString(1) + "Upc: " + resultSet.getString(2) 
					+ ", Title: " + resultSet.getString(3) + ", Condition: " + resultSet.getString(5)
					+ ", Genre: " + resultSet.getString(6) + ", Type: " + resultSet.getString(7)
